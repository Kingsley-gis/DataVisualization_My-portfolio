...
// 异步加载防止未读取数据就执行地图配置，需要使用map.on（）
    ODline1.on('load',function(){
      ...
      ODline1.addSource("center",{
          type:"geojson",
          data:"./citycenter.json"
        });
  
        ODline1.addSource("FirstOD",{
          type:"geojson",
          data:"./ODLinejson/First.json"
        });
  
        ODline1.addSource("SecondOD",{
          type:"geojson",
          data:"./ODLinejson/Second.json"
        });
  
  
        ODline1.addSource("ThirdOD",{
          type:"geojson",
          data:"./ODLinejson/Third.json"
        });
  
        ODline1.addSource("ForthOD",{
          type:"geojson",
          data:"./ODLinejson/Forth.json"
        });
  
        ODline1.addSource("FiveOD",{
          type:"geojson",
          data:"./ODLinejson/Five.json"
        });
  
        ODline1.addSource("SixthOD",{
          type:"geojson",
          data:"./ODLinejson/Six.json"
        });
  
        ODline1.addSource("SeventhOD",{
          type:"geojson",
          data:"./ODLinejson/Seven.json"
        });
  
        ODline1.addSource("LastOD",{
          type:"geojson",
          data:"./ODLinejson/Last.json"
        });
